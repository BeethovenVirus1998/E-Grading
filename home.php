...
?>
    ...
    <link rel="shortcut icon" href="polindra.ico" type="image/x-icon">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><img src="images/POLINDRA.png" class="img-circle" width="70"></p>
